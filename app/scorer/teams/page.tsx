...
export default function ManageTeamsPage() {
  ...
  const winMsg = (match: any, teamName: string) => {
    ...
    if (match.winner === teamName) {
      ...
      if (secondBattingTeamName === teamName) {
        const secondBattingTeam = teamName === match.teamB.name ? match.teamB : match.teamA;
        const w = secondBattingTeam.players.length - match.innings.second.wickets;
