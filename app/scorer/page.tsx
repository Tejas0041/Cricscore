    ...
    <div className="min-h-screen pb-8">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <button
            onClick={() => router.push('/scorer/tournament')}
            className="glass-card elevated-hover p-6 rounded-xl transition-all text-left group"
          >
            <div className="w-12 h-12 bg-gradient-to-br from-amber-500 to-yellow-400 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <span className="text-2xl">🏆</span>
            </div>
            <h2 className="text-xl font-bold mb-2">Tournaments</h2>
            <p className="text-sm opacity-60">Create and manage tournaments</p>
          </button>
        </div>
      </main>
    </div>
