            ...
            <>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                const winMsg = (() => {
                  ...
                  const secondBattingTeam = secondBattingTeamName === match.teamB.name ? match.teamB : match.teamA;
                  if (match.winner === secondBattingTeamName) {
                    const w = (secondBattingTeam.players?.length || 0) - match.innings.second.wickets;
